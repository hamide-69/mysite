...
function Nav() {
    ...
    <NavLink  activeClassName="navbar__link--active" style={navStyle} to='/login'> <li>Login</li></NavLink>
    <NavLink  activeClassName="navbar__link--active" style={navStyle} to='/uplode'> <li>Uplode</li></NavLink>
